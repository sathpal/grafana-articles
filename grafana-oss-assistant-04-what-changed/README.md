---
title: "\"What changed?\": the assistant builds a timeline from annotations and alert history (Part 4 of 6)"
published: false
description: "Two config changes two minutes apart, both visible in Grafana, only one is the root cause. An open-source AI assistant orders the evidence by first-breach time, reads alert history from Loki, and picks the quieter change."
